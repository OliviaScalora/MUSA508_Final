...
ggplot()+
  ...
  scale_fill_manual(values = c("#4281a4","#9cafb7", "#f26847", "#f6ad85", "#faebdd"),
                    labels=c('High Density Res','Low Density Res','Downtown','Commercial','Industrial')) +
  scale_size_continuous(breaks=seq(1, 4, by=1),
                        range = c(1,20))+
  geom_sf(data=city_boundary,color = 'black',size = 1,fill = NA)+
...
do.call(grid.arrange,c(zone_mapList, ncol=2, top="Density of Zone Type by Fishnet"))
...
do.call(grid.arrange,c(point_mapList, ncol=2, top="Risk Factor by Fishnet"))
...
do.call(grid.arrange,c(point_mapList.nn, ncol=2, top="Nearest Neighbor Risk Factors by Fishnet"))
```
</div>
<br>
...
do.call(grid.arrange,c(census_mapList, ncol=2, top="Risk Factor by Fishnet"))
...
do.call(grid.arrange,c(census_mapList.nn, ncol=2, top="Risk Factor by Fishnet"))
```
</div>
<br>
...
<div class="plot">
```{r local.moran.plot, echo=FALSE, results='hide', message=FALSE, warning=FALSE,fig.width =10, fig.height =10}

do.call(grid.arrange,c(varList, ncol = 2, top = "Local Morans I statistics, Mesa, AZ Overdose Incidents", bottom = "fig 4"))
...
# POISSON REGRESSION
```{r reg, results='hide', echo=FALSE, results='hide', message=FALSE, warning=FALSE}
...
error_by_reg_and_fold %>% ggplot(aes(MAE))+
  ...
  labs(title='Distribution of MAE', subtitle='k-fold cross validation vs. LOGO-CV',
       x= 'Mean Absolute Erorr', y = 'Count')+plotTheme()+theme(strip.text.x = element_text(size = 10),
                    strip.background = element_rect(fill= '#f0efeb', color=NA))
...
<div class="plot">
```{r reg.pred.map, echo=FALSE, message=FALSE, warning=FALSE,fig.width =10,fig.height =8}
