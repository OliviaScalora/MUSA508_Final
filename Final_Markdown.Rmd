...
Our end goal with the geospatial risk model is to produce a tool that can be used by Mesa health officials to implement harm reduction strategies through proactive resource allocation. We've conceptualized a program that will create facilities throughout Mesa, called Opioid Observation and Treatment Centers (OOTC). An OOTC will serve two purposes:
...
Through this analysis, we hope to identify locations throughout Mesa that will benefit most from the creation of Opioid Observation and Treatment Centers, and provide recommendations for future intervention. City and healthcare officials can properly allocate staff and resources to creating these centers with the goal of mitigating opioid overdose death.
